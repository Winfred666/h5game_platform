...
CREATE TABLE "game" (
    ...
    "width" INTEGER,
    "height" INTEGER,
    "is_auto_started" BOOLEAN NOT NULL DEFAULT false,
    "use_shared_array_buffer" BOOLEAN NOT NULL DEFAULT false,
    "has_fullscreen_button" BOOLEAN NOT NULL DEFAULT true,
    "enable_scrollbars" BOOLEAN NOT NULL DEFAULT true,
